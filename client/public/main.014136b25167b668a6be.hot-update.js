...
var App = function App() {
  return _react2.default.createElement('div', null, _react2.default.createElement(_reactRouterDom.Route, { path: '/', exact: true, component: _pages.HomePage }), _react2.default.createElement(_reactRouterDom.Route, { path: '/login', exact: true, component: _pages.LoginPage }), _react2.default.createElement(_reactRouterDom.Route, { path: '/adminpage', exact: true, component: _pages.Dashboard, onEnter: requireAuth() }));
};
function requireAuth(nextState, replace) {
  if (localStorage.myUserT) {
    ...
    if (!decode.role === 'admin') {
      ...
      replace({
        pathname: '/login',
        state: { nextPathname: nextState.pathname }
      });
    }
