...
var App = function App(_ref) {
  ...
  return _react2.default.createElement('div', null, _react2.default.createElement(_reactRouterDom.Route, { location: location, path: '/', exact: true, component: _pages.HomePage }), _react2.default.createElement(_reactRouterDom.Route, { path: '/login', exact: true, component: _pages.LoginPage }), _react2.default.createElement(_routes.AdminRoute, { path: '/dashboard', exact: true, component: _pages.DashboardPage }));
};
...
if (localStorage.myUserT) {
  ...
  store.dispatch((0, _auth.userLoggedIn)(pass));
  console.log(pass);
}
