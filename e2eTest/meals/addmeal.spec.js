...
module.exports = {
  ...
  'should show a meal form': (browser) => {
    browser
      ...
      .pause(5000)
      .setValue('#name', 'Rice')
      .setValue('#root > div > div.m-o-Content.space-content > div.add-meal-c.go-left > form > div:nth-child(3) > div > textarea', 'We want to be that little extra something that adds value to your everyday lives - we call it EVERYDAY MAGIC.')
      .setValue('#price', 999)
  ...
  'should create a new meal': (browser) => {
    browser
      .refresh()
      .pause(2000)
      .setValue('input[type=file]', imagePath)
